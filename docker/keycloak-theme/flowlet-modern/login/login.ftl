...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    <#if section = "header">
        Welcome to ${kcSanitize(realm.displayName!'Flowlet')?no_esc}
    <#elseif section = "form">
        <div id="kc-form">
    ...
    <#elseif section = "socialProviders" >
        <#if realm.password && social?? && social.providers?has_content>
            <div id="kc-social-providers" class="flowlet-social-providers">
                <div class="flowlet-social-buttons">
                    <#list social.providers as p>
                        <a data-once-link data-disabled-class="${properties.kcFormSocialAccountListButtonDisabledClass!}" id="social-${p.alias}"
                                class="flowlet-social-button" type="button" href="${p.loginUrl}">
                            <#if p.iconClasses?has_content>
                                <span class="flowlet-social-icon ${properties.kcCommonLogoIdP!} ${p.iconClasses!}" aria-hidden="true"></span>
                            </#if>
                            <span class="flowlet-social-label">${p.displayName!}</span>
                        </a>
                    </#list>
                </div>
                <div class="flowlet-divider"><span>or</span></div>
            </div>
        </#if>
    </#if>
